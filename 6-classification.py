...
def SVM_classification(feature_file_path, target_names=None, output_subdir='classification'):
    ...
    try:
        ...
        cm_display.ax_.set_xlabel("Predicted label", fontsize=13, fontweight='bold')
        cm_display.ax_.set_ylabel("True label", fontsize=13, fontweight='bold')
        plt.setp(cm_display.ax_.get_xticklabels(), rotation=20, ha='right', fontsize=12)
        plt.setp(cm_display.ax_.get_yticklabels(), fontsize=12)
